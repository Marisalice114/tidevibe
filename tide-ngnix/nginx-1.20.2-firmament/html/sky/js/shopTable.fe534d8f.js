                ...
                value: function (t) {
                  ...
                  if ("string" === typeof t) {
                    if (0 == this.checkList.length)
                      return (
                        this.$message.error("批量操作，请先勾选操作商品！"), !1
                      );
              ...
              value: function (t, e) {
                ...
                this.$refs[t].validate(function (t) {
                  ...
                  if (0 === a.dishTable.length)
                    return a.$message.error("套餐下商品不能为空");
                  if (!a.ruleForm.image)
            ...
            },
            {
              ...
              get: function () {
                return {
                  ...
                  image: { required: !0, message: "商品图片不能为空" },
                  price: {
                    required: !0,
                    validator: function (t, e, a) {
                  ...
                  a("el-scrollbar", { staticStyle: { height: "100%" } }, [
                    ...
                    a("div", { staticClass: "order-middle" }, [
                      ...
                      a("div", { staticClass: "dish-info" }, [
                        a("div", { staticClass: "dish-label" }, [t._v("商品")]),
                        a(
                          "div",
              ...
              [
                n(
                  ...
                  [
                    ...
                    n("el-input", {
                      staticStyle: { width: "14%" },
                      attrs: { placeholder: "请填写商品名称", clearable: "" },
                      on: { clear: t.init },
                      nativeOn: {
                        keyup: function (e) {
                          return !e.type.indexOf("key") &&
                ...
                t.tableData.length
                  ? n(
                      ...
                      [
                        ...
                        n("el-table-column", {
                          attrs: { prop: "categoryName", label: "商品分类" },
                        }),
                        n("el-table-column", {
                          attrs: { label: "售价" },
                          scopedSlots: t._u(
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                this.$refs[t].validate(function (t) {
                  ...
                  if (!a.ruleForm.image)
                    return a.$message.error("商品图片不能为空");
                  var n = D({}, a.ruleForm);
                  (n.status =
                    "add" === a.actionType ? 0 : a.ruleForm.status ? 1 : 0),
                      ...
                      validator: function (t, e, a) {
                        if (e) {
                          ...
                          n.test(e)
                            ? a()
                            : a(
                                new Error("商品名称输入不符，请输入2-20个字符")
                              );
                        } else a(new Error("请输入商品名称"));
                      },
                      trigger: "blur",
                    },
                  ],
